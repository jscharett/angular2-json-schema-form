...
export declare class JsonPointer {
     ...
     */
    static toControlPointer(dataPointer: Pointer, formGroup: any, controlMustExist?: boolean): string;
    /**
     ...
     */
    static toDataPointer(schemaPointer: Pointer, schema: any, errors?: boolean): string;
    /**
